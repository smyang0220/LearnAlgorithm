...
<td>c</td>
      ...
      </table><div class="highlight" bis_skin_checked="1"><pre class="codehilite"><code>2열에 적힌 글자를 세로로 읽으면 happy이므로 "happy"를 return 합니다.
</code></pre></div>
<p>입출력 예 #2</p>
